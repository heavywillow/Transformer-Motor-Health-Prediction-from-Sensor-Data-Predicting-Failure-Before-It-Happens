...
4. Train classifier: Logistic Regression first (simple, explainable), then Random Forest (better accuracy)
5. Predict on the 20% test set
6. Report: Accuracy, Precision, Recall, Confusion Matrix
7. Feature importance plot — "which sensor reading matters most for predicting failure" 
